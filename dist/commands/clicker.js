...
import { cancelPendingClaim, createClaimCheckout, getClickerDashboard, renderClickerScreen, runFactoryTap } from "../services/clickerService.js";
import { buyHashRushBoost, buyHashRushUpgrade, collectHashRush, getHashRushDashboard, getHashRushLeaderboard, mineHashRush, renderHashRushBoosts, renderHashRushDashboard, renderHashRushUpgrades } from "../services/hashRushService.js";
...
export async function showClicker(ctx) {
    const from = ctx.from;
    if (!from) {
...
export async function showFactory(ctx) {
    if (!ctx.from) {
...
export async function showMine(ctx) {
    if (!ctx.from) {
        await ctx.reply("Hash Rush could not read your Telegram profile.");
        return;
    }
...
export async function showCollect(ctx) {
    if (!ctx.from) {
        await ctx.reply("Hash Rush could not read your Telegram profile.");
        return;
    }
...
export async function showHashRushUpgrades(ctx) {
    if (!ctx.from) {
        await ctx.reply("Hash Rush could not read your Telegram profile.");
        return;
    }
...
export async function showBuyHashRushUpgrade(ctx) {
...
export async function showHashRushBoosts(ctx) {
    if (!ctx.from) {
        await ctx.reply("Hash Rush could not read your Telegram profile.");
        return;
    }
...
export async function showBuyHashRushBoost(ctx) {
    if (!ctx.from || !ctx.message || !("text" in ctx.message)) {
...
export async function showHashRushEnergy(ctx) {
    if (!ctx.from) {
        await ctx.reply("Hash Rush could not read your Telegram profile.");
        return;
    }
...
export async function showHashRushLeaderboard(ctx) {
    try {
...
export async function showRunFactory(ctx) {
    const from = ctx.from;
    if (!from) {
        await ctx.reply("MIND FACTORY could not read your Telegram profile.");
        return;
...
export async function showClaimMind(ctx) {
    const from = ctx.from;
    if (!from) {
        await ctx.reply("MIND FACTORY could not read your Telegram profile.");
        return;
...
export async function showCancelClaim(ctx) {
    const from = ctx.from;
    if (!from) {
        await ctx.reply("MIND FACTORY could not read your Telegram profile.");
        return;
...
export function registerClickerCommand(bot) {
