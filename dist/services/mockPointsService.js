...
function pseudoNumber(seed, modulo, offset = 0) {
    return Number(seed % BigInt(modulo)) + offset;
}
export function getMockProfileStats(telegramId) {
    ...
    return {
        ...
        recentEvents: ["Starter rig purchase", "Daily activity bonus", "MIND claim"].slice(0, pseudoNumber(telegramId, 3, 1))
    };
}
