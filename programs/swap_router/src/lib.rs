...
fn giga_probability(usd_cents: u64) -> u64 {
    match usd_cents {
        ...
        500..=1_099     => 10, // $5–$10     → 10%
        1_100..=2_299   => 11, // $11–$22    → 11%
        2_300..=4_699   => 12, // $23–$46    → 12%
        4_700..=7_699   => 13, // $47–$76    → 13%
        7_700..=10_099  => 13, // $77–$100   → 13%
        10_100..=13_199 => 14, // $101–$131  → 14%
        13_200..=16_799 => 15, // $132–$167  → 15%
        _               => 16, // $168+      → 16% (max)
    }
}
