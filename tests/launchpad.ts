...
describe("launchpad", () => {
  ...
  const REWARD_POOL_TOKEN_ALLOCATION = new BN(100_000_000).mul(new BN(DECIMALS_MULTIPLIER));
  const GRAD_RESERVE_ALLOCATION = new BN(50_000_000).mul(new BN(DECIMALS_MULTIPLIER));
