              ...
              <div className="mt-2 bg-[#0d1117] border border-neon/20 rounded-2xl p-5 space-y-5 text-sm">
                ...
                <div>
                  ...
                  <div className="space-y-1.5 text-xs text-zinc-500">
                    ...
                    <div className="flex justify-between"><span className="text-zinc-400">GigaSwap reward pool</span><span className="font-mono text-zinc-300">5%</span></div>
                    ...
                    <div className="flex justify-between"><span className="text-zinc-400">Creator allocation</span><span className="font-mono text-zinc-300">1%</span></div>
                  </div>
                </div>
