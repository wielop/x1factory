...
const LEVEL_ROWS = [
  ...
  { levelNumber: 2, level: "Level 2", xp: "500 XP", bonus: "+1.6%", cost: "150 MIND" },
  { levelNumber: 3, level: "Level 3", xp: "2,000 XP", bonus: "+3.4%", cost: "350 MIND" },
  { levelNumber: 4, level: "Level 4", xp: "5,000 XP", bonus: "+5.5%", cost: "900 MIND" },
  { levelNumber: 5, level: "Level 5", xp: "10,000 XP", bonus: "+7.8%", cost: "2,000 MIND" },
  { levelNumber: 6, level: "Level 6", xp: "16,000 XP", bonus: "+10.0% (cap)", cost: "4,000 MIND" },
] as const;
