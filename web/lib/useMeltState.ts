      ...
      if (cfg.activeRoundActive) {
        ...
        if (activeInfo) {
          try {
            ...
            // keep searching fallback rounds
          }
        }
      }
      ...
      if (publicKey) {
        ...
        for (const acc of userRoundAccounts) {
          try {
            ...
            if (!roundInfo || !roundInfo.owner.equals(meltProgramId)) continue;
            ...
            // skip malformed or incompatible legacy rows
          }
        }
